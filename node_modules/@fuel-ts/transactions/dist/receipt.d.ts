...
export declare const createAssetId: (contractId: string, subId: string) => AssetId;
export declare const getMessageId: (value: Pick<ReceiptMessageOut, "sender" | "recipient" | "nonce" | "amount" | "data">) => string;
