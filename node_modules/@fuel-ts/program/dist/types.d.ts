...
import type { CallResult, CoinQuantity, CoinQuantityLike, TransactionResponse, TransactionResult, TransactionType, AbstractAccount, Provider } from '@fuel-ts/account';
...
export declare abstract class AbstractContract extends AbstractProgram implements WithContractId {
    abstract id: Address;
}
/**
