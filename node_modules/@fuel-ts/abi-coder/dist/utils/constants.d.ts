...
export declare const B512_CODER_TYPE = "struct std::b512::B512";
export declare const OPTION_CODER_TYPE = "enum std::option::Option";
export declare const VEC_CODER_TYPE = "struct std::vec::Vec";
export declare const BYTES_CODER_TYPE = "struct std::bytes::Bytes";
export declare const STD_STRING_CODER_TYPE = "struct std::string::String";
export declare const STR_SLICE_CODER_TYPE = "str";
export declare const VOID_TYPE = "()";
...
export declare const fullNameRegExMatch: RegExp;
/**
 * Encoding versions
 */
